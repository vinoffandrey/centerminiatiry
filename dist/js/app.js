...
(() => {
  ...
  (() => {
    ...
    function ve(e) {
      ...
      function r() {
        ...
        const i = e.clickedIndex,
          s = e.clickedSlide;
        if (s && _(s).hasClass(t.params.thumbs.slideThumbActiveClass)) return;
        if (null == i) return;
        let n;
        if (
          ((n = e.params.loop
            ? parseInt(_(e.clickedSlide).attr("data-swiper-slide-index"), 10)
            : i),
          t.params.loop)
        ) {
          let e = t.activeIndex;
    ...
    window.addEventListener("load", function (e) {
      ye(),
        document.querySelector(".awards__swiper") &&
          new ue(".awards__slider", {
            modules: [pe, me, fe],
            effect: "fade",
        ...
        document.querySelector(".photo__swiper") &&
          new ue(".photo__slider", {
            modules: [pe, me, fe],
            effect: "fade",
          ...
          (e.prototype.loadContent = function (e, t) {
            ...
            if (
              ...
              if (m) {
                ...
                S = Ke(o, x || "", g, this.settings.strings.playVideo, p);
                n.prepend(S);
              } else if (p) {
      ...
      mt = (function () {
        function e(e, t) {
          return (
            (this.core = e),
            (this.$LG = t),
            (this.settings = nt(nt({}, ot), this.core.settings)),
            this
          );
        }
        return (
          ...
          (e.prototype.enableZoomOnSlideItemLoad = function () {
            this.core.LGel.on(dt + ".zoom", this.enableZoom.bind(this));
          }),
          ...
          (e.prototype.init = function () {
            ...
            if (this.settings.zoom) {
              ...
              this.core.outer.on("dblclick.lg", function (t) {
                ...
                this.core.LGel.on(ct + ".zoom", function (t) {
      ...
      Ot = (function () {
        function e(e, t) {
          return (
            (this.core = e),
            (this.$LG = t),
            (this.settings = Ct(Ct({}, Lt), this.core.settings)),
            this
          );
        }
        return (
